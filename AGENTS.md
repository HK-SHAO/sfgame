...
- `bun run bench:moon` = 内核性能基线（moon bench；满网格流体步 ≈1.97ms，纯标量 GS（无 SIMD）+ MacCormack 平流；GS SIMD 因 bun/JSC 全 bulk 路径误编译弃用，见 pitfalls I8）
