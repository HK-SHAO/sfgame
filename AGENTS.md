...
- `bun run bench:moon` = 内核性能基线（moon bench；满网格流体步 ≈1.7ms：标量 Moonbit 1.16× AS SIMD + 空气索引表/GS SIMD 共 -28%，位精确）
